...
namespace astn_course.Handled
{
  public static class Shared
  {
    ...
    /// <summary>
    /// Chuyển mốc thời gian trong ngày về đầu tháng ticks
    /// </summary>
    public static long DateToMonthTicks(DateTime date)
    {
      return Convert.ToDateTime(date.ToString("yyyy-MM-01")).Ticks;
    }
    ...
    public static string ConvertOnlyDate(DateTime? date)
    {
      DateTime DateTimeNow = DateTime.Now;
      string postTime = string.Empty;
      if (date != null)
    ...
    public static string GetTimeName(int type)
    {
      if (type == 1)
        ...
        return "7 ngày tiếp theo";
      else if (type == 9)
        return "14 ngày tiếp theo";
      else if (type == 10)
        return "30 ngày tiếp theo";
      else if (type == 11)
        return "Tuần trước";
      else if (type == 12)
        return "60 ngày tiếp theo";
      else if (type == 13)
        return "180 ngày tiếp theo";
      else if (type == 14)
        return "7 ngày gần đây";
      else if (type == 15)
        return "14 ngày gần đây";
      else if (type == 16)
        return "30 ngày gần đây";
      else if (type == 17)
        return "60 ngày gần đây";
      else if (type == 22)
        return "Tháng trước";
      return "";
    }
    ...
    public static List<string> ToggleListString(this  List<string> list, string item)
    {
